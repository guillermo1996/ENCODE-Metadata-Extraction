...
```{r echo=FALSE}
metadata_df %>% select(mapped_run_type, lab, assay, nucleic_acid_type, extraction_method, fragmentation_method, size_selection_method, strand_specificity) %>% distinct() %>%
  kableExtra::kbl() %>%
